...
const EmptyCart = () => {
  return (
    <>
      <aside className="flex h-fit min-w-[22rem] flex-col rounded-xl bg-white px-8 pb-10 pt-6 ~sm/md:~gap-10/2">
        ...
        <div className="flex flex-1 flex-col items-center justify-center font-bold ~sm/md:~gap-4/2">
          ...
          <span className="whitespace-nowrap text-sm font-medium text-roseC-500">
